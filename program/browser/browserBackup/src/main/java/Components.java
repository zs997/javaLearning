...
public class Components extends  JFrame{
   ...
   /*
   public void init_others(ActionListener actionListener){
        this.actionListener = actionListener;
        init_others();
    }
    */
     ...
     * */
    /*
    public void init_commandGroup(DataSource dataSource){
        init_commandGroup(dataSource.getProperties_command());
    }
    */
    ...
    public  void refresh_jpanel_commandBtn(){
        ...
        public  void refresh_jpanel_commandBtn(){
            ...
            // 运行时数据源
            Properties properties_command = dataSource.getProperties_command();
            refresh_jpanel_commandBtn(properties_command);
        }
        */
